...
The REST API is specified in [`openapi.yaml`](openapi.yaml) at the root of this
repository. It is the authoritative description of every endpoint this server
exposes -- auth, MFA, SSO/SAML, the OAuth 2.1 server, SCIM and the admin API --
and it is kept in sync with the code as part of review.

Render it with any OpenAPI viewer, or read the guide-style documentation at
